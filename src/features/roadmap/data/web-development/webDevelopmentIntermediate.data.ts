// Web Development Masterclass — Level 2: Intermediate Data
// Auto-generated by build_web_dev_intermediate.cjs

import { Task, QuizQuestion } from '../../types/roadmap.types';

export const WEB_DEV_INTERMEDIATE_ASSESSMENT: QuizQuestion[] = [
  {
    "id": 1,
...
export const WEB_DEV_INTERMEDIATE_TASKS: Task[] = [
  {
    "id": "web-int-01",
    "orderIndex": 1,
    "title": "1. Advanced JavaScript: Closures, Prototypes & Scope Chains",
    "description": "Master lexical scoping, closure memory mechanics, prototypal inheritance, and explicit execution context binding (call, apply, bind).",
    "duration": "26 min",
    "level": "intermediate",
    "status": "locked",
    "isProject": false,
      ...
      "sections": [
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "// Memoization Cache using Closure\nfunction memoize(fn) {\n  const cache = new Map(); // Private cache in closure scope\n  return function(...args) {\n    const key = JSON.stringify(args);\n    if (cache.has(key)) {\n      return cache.get(key);\n    }\n    const result = fn.apply(this, args);\n    cache.set(key, result);\n    return result;\n  };\n}\n\nconst slowSquare = n => { for (let i = 0; i < 1e7; i++); return n * n; };\nconst fastSquare = memoize(slowSquare);\nconsole.log(fastSquare(9)); // Computes & Caches\nconsole.log(fastSquare(9)); // Instant cache hit",
              "explanation": "When a function is defined, JavaScript records its outer lexical environment. When an outer function completes execution and its stack frame is popped from the call stack, any inner functions that reference outer variables keep those variables alive in heap memory. This mechanism is called a Closure. Closures power private state encapsulation, memoization caches, and function currying.",
              "lineByLine": [
                {
                  "line": "const cache = new Map();",
                  "explanation": "Instantiates private cache map preserved in the closure scope."
                },
                {
                  "line": "if (cache.has(key)) return cache.get(key);",
                  "explanation": "Returns cached value immediately if arguments have been evaluated previously."
                },
                {
                  "line": "const result = fn.apply(this, args);",
                  "explanation": "Executes original function with current context and arguments on cache miss."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "Create a function createRateLimiter(fn, limitMs) that uses a closure to prevent a function from being called more than once per limitMs milliseconds.",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "function createRateLimiter(fn, limitMs) { let last = 0; return (...args) => { const now = Date.now(); if (now - last >= limitMs) { last = now; return fn(...args); } }; }"
          }
        },
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "// Prototypal Inheritance with Object.create()\nconst userPrototype = {\n  login() {\n    this.isOnline = true;\n    console.log(`${this.username} logged in.`);\n  }\n};\n\nfunction createUser(username, email) {\n  const user = Object.create(userPrototype);\n  user.username = username;\n  user.email = email;\n  user.isOnline = false;\n  return user;\n}\n\nconst alex = createUser('alex_dev', 'alex@skillora.ai');\nalex.login(); // \"alex_dev logged in.\"",
              "explanation": "JavaScript does not use traditional class-based inheritance under the hood; it utilizes Prototypal Inheritance. Every JavaScript object has an internal [[Prototype]] link (accessible via Object.getPrototypeOf()) pointing to another object. When a property or method is accessed on an object, the engine searches the object itself, then traverses up its prototype chain until found or reaching Object.prototype (null).",
              "lineByLine": [
                {
                  "line": "const user = Object.create(userPrototype);",
                  "explanation": "Creates a new object whose [[Prototype]] points directly to userPrototype."
                },
                {
                  "line": "alex.login();",
                  "explanation": "Engine fails to find login on alex instance, walks prototype chain, and executes userPrototype.login."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "What does Object.prototype.__proto__ return?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "Object.prototype.__proto__ returns null, indicating the termination of the prototype chain."
          }
        },
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "const accountService = {\n  accountType: 'Enterprise',\n  logDetails(region, tier) {\n    console.log(`[${this.accountType}] Region: ${region}, Tier: ${tier}`);\n  }\n};\n\nconst customAccount = { accountType: 'Startup' };\n\n// 1. call (comma-separated args)\naccountService.logDetails.call(customAccount, 'US-East', 'Gold');\n\n// 2. apply (array args)\naccountService.logDetails.apply(customAccount, ['EU-West', 'Silver']);\n\n// 3. bind (returns permanently bound function)\nconst logStartup = accountService.logDetails.bind(customAccount, 'Global');\nlogStartup('Platinum');",
              "explanation": "The this value inside standard functions depends on how the function is invoked. JavaScript provides three explicit binding methods: call() (invokes immediately passing arguments individually), apply() (invokes immediately passing arguments as an array), and bind() (returns a new function permanently bound to the specified context object).",
              "lineByLine": [
                {
                  "line": "accountService.logDetails.call(customAccount, ...)",
                  "explanation": "Explicitly sets this to customAccount and executes with provided arguments."
                },
                {
                  "line": "accountService.logDetails.apply(customAccount, [...])",
                  "explanation": "Explicitly sets this and spreads the argument array."
                },
                {
                  "line": "const logStartup = accountService.logDetails.bind(...)",
                  "explanation": "Creates a new wrapper function permanently locking this to customAccount."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "Why is .bind() frequently used in event listeners when passing object methods as callbacks?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "Without .bind(this), the method's this inside the event listener would point to the DOM element instead of the original class or object instance."
          }
        }
      ],
      "keyTakeaways": [
  ...
  },
  {
    ...
    "description": "Master object/array destructuring, rest/spread operators, optional chaining (?.), nullish coalescing (??), Map, and Set.",
    "duration": "25 min",
    "level": "intermediate",
    "status": "locked",
    "isProject": false,
      ...
      "sections": [
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "// Immutable State Update with Spread\nconst userProfile = {\n  id: 'usr_101',\n  name: 'Elena Rostova',\n  preferences: { theme: 'light', locale: 'en-US' }\n};\n\n// Clone and update nested object immutably\nconst updatedProfile = {\n  ...userProfile,\n  name: 'Elena R.',\n  preferences: {\n    ...userProfile.preferences,\n    theme: 'dark'\n  }\n};\n\nconsole.log(updatedProfile.preferences.theme); // \"dark\"\nconsole.log(userProfile.preferences.theme);    // \"light\" (Unmutated)",
              "explanation": "Destructuring syntax allows unpacking values from arrays or properties from objects into distinct variables in a single expressive statement. The spread operator (...) expands iterable arrays or object properties into new structures, enabling immutable updates. Rest parameters (...args) collect arbitrary remaining function arguments into a true Array.",
              "lineByLine": [
                {
                  "line": "...userProfile,",
                  "explanation": "Copies all top-level properties from userProfile into the new object."
                },
                {
                  "line": "...userProfile.preferences, theme: 'dark'",
                  "explanation": "Creates a new nested preferences object with the updated theme property."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "Use array destructuring to swap the values of two variables let a = 1; let b = 2; in one line without a temporary variable.",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "[a, b] = [b, a]; // a is now 2, b is now 1"
          }
        },
        {
          ...
          "codeSnippets": [
            {
              ...
              "explanation": "Optional Chaining (?.) short-circuits evaluation and returns undefined if the object before the question mark is null or undefined, rather than throwing a fatal TypeError. Nullish Coalescing (??) provides a fallback value only when the left expression is strictly null or undefined, preserving valid values like 0, false, and empty strings \"\".",
              "lineByLine": [
                {
                  "line": "apiResponse.data?.user?.avatar?.url",
                  "explanation": "Safely returns undefined when avatar is missing without crashing."
                },
                {
                  "line": "?? '/images/default-avatar.png'",
                  "explanation": "Applies fallback avatar because avatar.url evaluated to undefined."
                },
                {
                  "line": "notificationsEnabled ?? true",
                  "explanation": "Correctly preserves the boolean value false instead of overriding with true."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "Why would using (apiResponse.data?.unreadCount || 10) produce a bug if unreadCount is 0?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "Because 0 is falsy, || would fall back to 10 even though the user has 0 unread notifications. Using ?? correctly preserves 0."
          }
        },
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "// Array Deduplication & Frequency Tracking\nconst tagList = ['react', 'css', 'typescript', 'react', 'vite', 'css'];\nconst uniqueTags = [...new Set(tagList)]; // ['react', 'css', 'typescript', 'vite']\n\n// Frequency Map\nconst frequencyMap = new Map();\nfor (const tag of tagList) {\n  frequencyMap.set(tag, (frequencyMap.get(tag) || 0) + 1);\n}\n\nconsole.log('React tag count:', frequencyMap.get('react')); // 2",
              "explanation": "The Set object is a collection of unique values of any type. Adding duplicates to a Set has no effect. The Map object holds key-value pairs and remembers the original insertion order of the keys. Unlike plain objects, Map keys can be of any data type (including objects, functions, and arrays) and provide an O(1) .size property.",
              "lineByLine": [
                {
                  "line": "[...new Set(tagList)]",
                  "explanation": "Constructs a Set to remove duplicates, then spreads back into an array."
                },
                {
                  "line": "frequencyMap.set(tag, ...)",
                  "explanation": "Updates occurrence count for the tag in the Map collection."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "What happens when you add two identical objects { id: 1 } to a Set?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "Both objects will be added because they have distinct memory reference pointers ({} !== {})."
          }
        }
      ],
      "keyTakeaways": [
  ...
  },
  {
    ...
    "description": "Master ECMAScript Modules (import/export), dynamic imports, circular dependency resolution, barrel files, and module bundling.",
    "duration": "24 min",
    "level": "intermediate",
    "status": "locked",
    "isProject": false,
      ...
      "sections": [
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "// services/auth.js (Exports)\nexport const AUTH_VERSION = '2.4.0';\nexport function authenticateUser(credentials) { /* ... */ }\nexport default function logout() { /* ... */ }\n\n// main.js (Imports)\nimport logout, { authenticateUser as login, AUTH_VERSION } from './services/auth.js';\n\nlogin({ user: 'admin' });",
              "explanation": "ES Modules support two types of exports: Named Exports (multiple per file, must be imported using exact matching identifiers inside curly braces {}) and Default Exports (one per file, imported without curly braces using any chosen identifier). Modules can also alias imports using the as keyword to prevent name collisions.",
              "lineByLine": [
                {
                  "line": "export const AUTH_VERSION = '2.4.0';",
                  "explanation": "Exports named constant available for selective importing."
                },
                {
                  "line": "authenticateUser as login",
                  "explanation": "Renames imported function locally to login to match application semantics."
                },
                {
                  "line": "import logout, { ... }",
                  "explanation": "Imports default export (logout) alongside named exports in one statement."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "What syntax allows importing all exports from a module into a single namespace object?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "import * as AuthUtils from \"./services/auth.js\"; (Access via AuthUtils.authenticateUser)."
          }
        },
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "// Lazy loading a charting library only when the user opens the Analytics tab\nasync function renderDashboardChart(containerId, data) {\n  // Dynamically load heavy Chart.js module\n  const { Chart } = await import('chart.js/auto');\n  \n  const ctx = document.getElementById(containerId);\n  new Chart(ctx, {\n    type: 'line',\n    data: {\n      labels: data.months,\n      datasets: [{ label: 'Revenue', data: data.values }]\n    }\n  });\n}",
              "explanation": "Static import statements must be placed at the top level of files and are resolved before execution. In contrast, the dynamic import() function can be called conditionally inside functions or event handlers, returning a Promise that resolves to the module namespace object. This enables on-demand code splitting for heavy libraries (like charting or PDF generators).",
              "lineByLine": [
                {
                  "line": "const { Chart } = await import('chart.js/auto');",
                  "explanation": "Downloads chart.js chunk over network only when this function is invoked."
                },
                {
                  "line": "new Chart(ctx, ...)",
                  "explanation": "Initializes chart instance after module script successfully downloads and parses."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "What happens to the initial page load bundle size when heavy dependencies are loaded dynamically via import()?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "The initial bundle size decreases significantly, speeding up initial page load and Time to Interactive (TTI)."
          }
        },
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "// components/index.js (Barrel Export File)\nexport { default as Button } from './Button.jsx';\nexport { default as Modal } from './Modal.jsx';\nexport { default as Card } from './Card.jsx';\nexport * from './types.js';\n\n// Consumer File (App.jsx)\n// Clean single-line import instead of 3 separate deep paths\nimport { Button, Modal, Card } from './components';",
              "explanation": "A barrel file is an index.js/ts file that re-exports functions, classes, and types from multiple sub-modules in a directory. This pattern simplifies imports for consuming modules, hiding internal file system layout behind a clean interface.",
              "lineByLine": [
                {
                  "line": "export { default as Button } from './Button.jsx';",
                  "explanation": "Re-exports default component export as a named export."
                },
                {
                  "line": "import { Button, Modal, Card } from './components';",
                  "explanation": "Consumes all components from the barrel entry point."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "What potential drawback can poorly configured barrel files have with older bundlers that lack tree-shaking?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "Without tree-shaking, importing one item from a barrel file might pull in all exported modules into the bundle."
          }
        }
      ],
      "keyTakeaways": [
  ...
  },
  {
    ...
    "description": "Master IntersectionObserver, MutationObserver, ResizeObserver, Custom Events, and Web Components with Shadow DOM.",
    "duration": "25 min",
    "level": "intermediate",
    "status": "locked",
    "isProject": false,
      ...
      "sections": [
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "// Scroll Spy Navigation with IntersectionObserver\nconst sections = document.querySelectorAll('main section');\nconst navLinks = document.querySelectorAll('.nav-link');\n\nconst sectionObserver = new IntersectionObserver((entries) => {\n  entries.forEach(entry => {\n    if (entry.isIntersecting) {\n      const id = entry.target.getAttribute('id');\n      navLinks.forEach(link => {\n        link.classList.toggle('active', link.getAttribute('href') === `#${id}`);\n      });\n    }\n  });\n}, { threshold: 0.6 }); // Triggers when 60% of section is visible\n\nsections.forEach(sec => sectionObserver.observe(sec));",
              "explanation": "IntersectionObserver detects when a target element enters or exits the viewport (or a specified ancestor container). By configuring rootMargin (loading assets before they enter screen) and threshold (percentage of element visibility), developers create fluid infinite scroll lists and scroll-spy navigation bars with zero performance penalty.",
              "lineByLine": [
                {
                  "line": "new IntersectionObserver((entries) => { ... }, { threshold: 0.6 })",
                  "explanation": "Creates observer triggering when 60% of a section occupies viewport."
                },
                {
                  "line": "link.classList.toggle('active', ...)",
                  "explanation": "Highlights corresponding navigation link in navbar dynamically."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "What does rootMargin: \"100px\" do when configuring an image lazy loader?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "It begins loading images 100 pixels before they physically enter the visible viewport, creating a seamless scroll experience."
          }
        },
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "// ResizeObserver for Container-Responsive Widget\nconst cardWidget = document.querySelector('.analytics-widget');\n\nconst resizeObserver = new ResizeObserver((entries) => {\n  for (const entry of entries) {\n    const { width } = entry.contentRect;\n    if (width < 400) {\n      entry.target.classList.add('compact-view');\n    } else {\n      entry.target.classList.remove('compact-view');\n    }\n  }\n});\n\nresizeObserver.observe(cardWidget);",
              "explanation": "MutationObserver watches for changes to the DOM tree—including node additions, removals, and attribute modifications. ResizeObserver monitors pixel dimension changes on individual elements (ideal for responsive widgets that adjust based on parent container width rather than global window width).",
              "lineByLine": [
                {
                  "line": "entry.contentRect",
                  "explanation": "Provides accurate real-time pixel width and height of observed element."
                },
                {
                  "line": "entry.target.classList.add('compact-view')",
                  "explanation": "Applies styling based on container dimension rather than window width."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "Why is ResizeObserver superior to listening to window.onresize for component-level responsiveness?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "ResizeObserver fires when the specific element resizes (e.g. sidebar collapse, layout reflow) regardless of window resize events."
          }
        },
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "// Dispatching and Listening to Custom Events\nconst cartButton = document.querySelector('#add-to-cart');\n\n// Dispatch Custom Event with payload\ncartButton.addEventListener('click', () => {\n  const event = new CustomEvent('cart:item-added', {\n    bubbles: true,\n    detail: { productId: 'sku_982', price: 49.99, quantity: 1 }\n  });\n  cartButton.dispatchEvent(event);\n});\n\n// Header listening to the decoupled event\ndocument.addEventListener('cart:item-added', (e) => {\n  console.log('Updating cart count for product:', e.detail.productId);\n});",
              "explanation": "Custom Events allow decoupled components to communicate without direct references. Using new CustomEvent(eventName, { detail: data }), elements dispatch domain events that any ancestor or listening component can intercept.",
              "lineByLine": [
                {
                  "line": "new CustomEvent('cart:item-added', { bubbles: true, detail: ... })",
                  "explanation": "Creates bubbling custom event with attached data payload."
                },
                {
                  "line": "cartButton.dispatchEvent(event);",
                  "explanation": "Fires event up through the DOM tree."
                },
                {
                  "line": "e.detail.productId",
                  "explanation": "Accesses custom payload data in the event listener."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "What option must be set to true on a CustomEvent so parent containers can intercept it as it bubbles up?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "bubbles: true must be set in the CustomEvent options."
          }
        }
      ],
      "keyTakeaways": [
      ...
      "practiceExercises": [
        {
          ...
          "solutionCode": "const observer = new IntersectionObserver((entries, obs) => {\n  entries.forEach(entry => {\n    if (entry.isIntersecting) {\n      const img = entry.target;\n      img.src = img.dataset.src;\n      obs.unobserve(img);\n    }\n  });\n});\ndocument.querySelectorAll('.lazy').forEach(img => observer.observe(img));"
        }
      ]
    }
  },
  {
    ...
    "description": "Master the JavaScript runtime concurrency model: Call Stack, Web APIs, Microtask vs Macrotask queues, Promise combinators, and Web Workers.",
    "duration": "26 min",
    "level": "intermediate",
    "status": "locked",
    "isProject": false,
      ...
      "sections": [
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "// Concurrency Demonstration\nfunction executeAsyncFlow() {\n  console.log('A: Sync Code');\n\n  setTimeout(() => {\n    console.log('D: Timer Macrotask');\n  }, 0);\n\n  queueMicrotask(() => {\n    console.log('C: Explicit Microtask');\n  });\n\n  Promise.resolve().then(() => {\n    console.log('B: Promise Microtask');\n  });\n}\n// Console Output: A -> C -> B -> D",
              "explanation": "The JavaScript runtime consists of a single Call Stack (executing synchronous frames), Web APIs (handling timers, DOM events, fetch requests off-thread), a Microtask Queue (Promises, queueMicrotask, MutationObserver), and a Macrotask Queue (setTimeout, setInterval, postMessage). When the call stack becomes empty, the Event Loop drains all pending microtasks before executing the single next macrotask.",
              "lineByLine": [
                {
                  "line": "console.log('A: Sync Code');",
                  "explanation": "Executes immediately on the call stack."
                },
                {
                  "line": "setTimeout(..., 0)",
                  "explanation": "Pushes callback to the Macrotask queue after timer resolves in Web APIs."
                },
                {
                  "line": "queueMicrotask(...)",
                  "explanation": "Queues high-priority microtask to execute immediately after current synchronous code."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "What happens if a microtask recursively enqueues another microtask continuously?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "It causes Microtask Starvation: the call stack never frees up for macrotasks or UI rendering, completely freezing the browser tab."
          }
        },
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "// Resilient Multi-Source Dashboard Aggregator\nasync function loadDashboardData() {\n  const results = await Promise.allSettled([\n    fetch('/api/metrics').then(r => r.json()),\n    fetch('/api/notifications').then(r => r.json()),\n    fetch('/api/feed').then(r => r.json())\n  ]);\n\n  const metrics = results[0].status === 'fulfilled' ? results[0].value : null;\n  const notifications = results[1].status === 'fulfilled' ? results[1].value : [];\n  const feed = results[2].status === 'fulfilled' ? results[2].value : [];\n\n  return { metrics, notifications, feed };\n}",
              "explanation": "When coordinating multiple asynchronous operations in parallel, JavaScript provides 4 specialized combinators: Promise.all() (fails fast if any promise rejects), Promise.allSettled() (waits for all to settle, returning status objects for every request), Promise.race() (resolves or rejects as soon as the first promise settles), and Promise.any() (resolves with the first fulfilled value, ignoring rejections until all fail).",
              "lineByLine": [
                {
                  "line": "Promise.allSettled([...])",
                  "explanation": "Executes all 3 fetch requests in parallel without failing if one endpoint is down."
                },
                {
                  "line": "results[0].status === 'fulfilled'",
                  "explanation": "Inspects outcome status safely before accessing value."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "How would you use Promise.race() to enforce a 5-second timeout on a fetch request?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "const timeout = new Promise((_, rej) => setTimeout(() => rej(new Error(\"Timeout\")), 5000)); const result = await Promise.race([fetch(url), timeout]);"
          }
        },
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "// Main Thread Script (app.js)\nconst worker = new Worker('/workers/parser.js');\n\n// Send heavy raw data to worker\nworker.postMessage({ rawCsvData: largeCsvString });\n\n// Receive parsed JSON output from worker thread\nworker.onmessage = (event) => {\n  console.log('Parsed dataset records:', event.data.records.length);\n};\n\n// Background Worker Script (parser.js)\n// self.onmessage = (e) => { const records = parseHeavy(e.data.rawCsvData); self.postMessage({ records }); };",
              "explanation": "When an application requires heavy CPU computation (such as client-side image compression, large CSV parsing, or cryptography), running it on the main thread freezes UI interactions and drops frame rates. Web Workers execute scripts on background OS threads, communicating with the main thread via message events.",
              "lineByLine": [
                {
                  "line": "new Worker('/workers/parser.js')",
                  "explanation": "Spawns dedicated background thread running parser script."
                },
                {
                  "line": "worker.postMessage(...)",
                  "explanation": "Transfers data payload to background worker thread."
                },
                {
                  "line": "worker.onmessage = ...",
                  "explanation": "Receives processed results back on the main thread without any UI lag."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "Can code running inside a Web Worker access document.getElementById or window?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "No. Web Workers run in a separate global scope (self) and do not have access to window or the DOM for thread safety."
          }
        }
      ],
      "keyTakeaways": [
  ...
  },
  {
    ...
    "description": "Master REST API design, HTTP/1.1 vs HTTP/2 vs HTTP/3, headers, status codes, and Cross-Origin Resource Sharing (CORS) security.",
    "duration": "25 min",
    "level": "intermediate",
    "status": "locked",
    "isProject": false,
      ...
      "sections": [
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "// Consuming RESTful Endpoints with Fetch API\nclass CourseAPI {\n  static async getCourse(courseId) {\n    const res = await fetch(`/api/v1/courses/${courseId}`);\n    if (!res.ok) throw new Error(`Fetch error: ${res.status}`);\n    return res.json();\n  }\n\n  static async updateProgress(courseId, completedTaskId) {\n    const res = await fetch(`/api/v1/courses/${courseId}/progress`, {\n      method: 'PATCH',\n      headers: { 'Content-Type': 'application/json' },\n      body: JSON.stringify({ completedTaskId })\n    });\n    return res.json();\n  }\n}",
              "explanation": "RESTful architecture treats data as resources identified by uniform resource identifiers (URIs). Endpoints use plural nouns (e.g. /api/courses) and leverage standard HTTP methods for CRUD operations: GET (Read), POST (Create), PUT (Replace), PATCH (Partial Update), and DELETE (Remove). Responses use structured JSON with standard HTTP status codes.",
              "lineByLine": [
                {
                  "line": "method: 'PATCH'",
                  "explanation": "Applies partial update to the progress sub-resource without replacing the course object."
                },
                {
                  "line": "headers: { 'Content-Type': 'application/json' }",
                  "explanation": "Specifies JSON MIME type for the outgoing request payload."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "What HTTP status code should a server return when a resource is successfully created via POST?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "HTTP 201 Created (often accompanied by a Location header containing the URI of the new resource)."
          }
        },
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "<!-- HTTP/2 Multiplexing in Practice -->\n<!-- Browsers can now download 50 small module chunks simultaneously over 1 connection -->\n<link rel=\"stylesheet\" href=\"/styles/base.css\">\n<link rel=\"stylesheet\" href=\"/styles/header.css\">\n<link rel=\"stylesheet\" href=\"/styles/card.css\">\n<!-- In HTTP/1.1, concatenating into 1 file was mandatory; in HTTP/2, granular caching of separate files is optimal -->",
              "explanation": "HTTP/1.1 suffered from head-of-line blocking because browsers could only send one request per TCP connection at a time (limiting browsers to 6 concurrent connections per domain). HTTP/2 introduced binary framing, header compression (HPACK), and multiplexing—allowing hundreds of concurrent requests over a single TCP connection. HTTP/3 replaces TCP with QUIC (built over UDP), eliminating transport-level head-of-line blocking caused by packet loss.",
              "lineByLine": [
                {
                  "line": "HTTP/2 Multiplexing",
                  "explanation": "Transfers multiple independent bidirectional streams over a single TCP socket."
                },
                {
                  "line": "Granular Caching",
                  "explanation": "Updating card.css only invalidates that specific file rather than an entire monolithic bundle."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "Why did developers concatenate all JavaScript and CSS files into single files in the HTTP/1.1 era?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "HTTP/1.1 had a 6-connection limit per domain; concatenation minimized the total number of round-trip HTTP requests."
          }
        },
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "// Example Express Backend CORS Header Configuration\n// app.use((req, res, next) => {\n//   res.header('Access-Control-Allow-Origin', 'https://app.skillora.ai');\n//   res.header('Access-Control-Allow-Methods', 'GET, POST, PATCH, DELETE, OPTIONS');\n//   res.header('Access-Control-Allow-Headers', 'Content-Type, Authorization');\n//   if (req.method === 'OPTIONS') return res.sendStatus(200);\n//   next();\n// });",
              "explanation": "Browsers enforce the Same-Origin Policy (SOP), preventing scripts on one domain (frontend.com) from reading responses from a different domain (api.backend.com) unless the server explicitly sends Cross-Origin Resource Sharing (CORS) permission headers. For non-simple requests, the browser issues an automated OPTIONS preflight request checking Access-Control-Allow-Origin, Access-Control-Allow-Methods, and Access-Control-Allow-Headers.",
              "lineByLine": [
                {
                  "line": "Access-Control-Allow-Origin",
                  "explanation": "Specifies which client domains are permitted to read cross-origin responses."
                },
                {
                  "line": "if (req.method === 'OPTIONS')",
                  "explanation": "Responds successfully to browser preflight permission checks."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "Why does setting Access-Control-Allow-Origin: * fail if a request includes credentials (cookies / Authorization header)?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "Security regulations forbid wildcard (*) origins when credentials are exchanged. The server must echo the specific explicit requesting origin."
          }
        }
      ],
      "keyTakeaways": [
  ...
  },
  {
    ...
    "description": "Master robust JSON parsing, runtime schema validation with Zod, optimistic UI updates, and normalized in-memory data caching.",
    "duration": "24 min",
    "level": "intermediate",
    "status": "locked",
    "isProject": false,
      ...
      "sections": [
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "// Safe JSON Parser Utility\nfunction safeJsonParse(jsonString, fallbackValue = null) {\n  if (typeof jsonString !== 'string') return fallbackValue;\n  try {\n    return JSON.parse(jsonString);\n  } catch (err) {\n    console.warn('JSON Parse Error:', err.message);\n    return fallbackValue;\n  }\n}\n\nconst valid = safeJsonParse('{\"status\":\"ok\"}', {}); // { status: \"ok\" }\nconst invalid = safeJsonParse('<html>Error</html>', {}); // {} (No crash)",
              "explanation": "Uncaught JSON.parse() calls are a leading cause of runtime crashes in production web apps. Malformed strings, unexpected empty responses, or non-JSON HTML error pages (like 502 Bad Gateway) throw SyntaxErrors. Wrapping parsing in resilient helper utilities guarantees application stability.",
              "lineByLine": [
                {
                  "line": "if (typeof jsonString !== 'string')",
                  "explanation": "Guards against non-string input values."
                },
                {
                  "line": "try { return JSON.parse(...) } catch (err)",
                  "explanation": "Catches syntax errors and returns the safe fallback value."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "What does JSON.stringify() do when passed an object containing a function or undefined property?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "It omits those keys from the output JSON string completely (or converts them to null if inside an array)."
          }
        },
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "// Zod Schema Definition and Inferred TypeScript Type\n// import { z } from 'zod';\n\n// const CourseSchema = z.object({\n//   id: z.string(),\n//   title: z.string().min(3),\n//   modules: z.number().int().positive(),\n//   isPublished: z.boolean()\n// });\n// type Course = z.infer<typeof CourseSchema>;\n\nasync function fetchAndValidateCourse(courseId) {\n  const res = await fetch(`/api/courses/${courseId}`);\n  const rawData = await res.json();\n  \n  // Runtime validation check\n  // const parsed = CourseSchema.safeParse(rawData);\n  // if (!parsed.success) throw new Error('Invalid Course Data Shape');\n  return rawData;\n}",
              "explanation": "TypeScript types exist only at compile-time and provide zero runtime protection against unexpected API responses. Schema validation libraries like Zod define schemas that validate data at runtime and automatically infer TypeScript types, creating an end-to-end type-safe boundary.",
              "lineByLine": [
                {
                  "line": "z.object({ ... })",
                  "explanation": "Defines runtime type constraints for each property."
                },
                {
                  "line": "CourseSchema.safeParse(...)",
                  "explanation": "Validates input object and returns success boolean with strongly typed data or error."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "Explain why schema validation is especially critical when consuming third-party APIs or user-generated JSON files.",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "External APIs may change formats or omit fields without notice; validation prevents silent application crashes down the component tree."
          }
        },
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "// Optimistic Like Button Pattern\nasync function handleLikePost(postId, currentLikes, updateUI) {\n  // 1. Snapshot previous state\n  const previousState = currentLikes;\n  \n  // 2. Optimistically update UI immediately\n  updateUI(previousState + 1);\n  \n  try {\n    const res = await fetch(`/api/posts/${postId}/like`, { method: 'POST' });\n    if (!res.ok) throw new Error('Like failed');\n  } catch (err) {\n    // 3. Rollback on network failure\n    updateUI(previousState);\n    alert('Could not save like. Please try again.');\n  }\n}",
              "explanation": "Optimistic UI updates improve perceived responsiveness by rendering the anticipated outcome of a user action immediately in the interface before the backend network request completes. If the server request fails, the application rolls state back to the previous snapshot and alerts the user.",
              "lineByLine": [
                {
                  "line": "updateUI(previousState + 1);",
                  "explanation": "Instantly reflects incremented like count in the UI."
                },
                {
                  "line": "updateUI(previousState);",
                  "explanation": "Rolls UI back to original count if network request rejects."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "What is state normalization in frontend data stores?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "Storing entities in flat objects keyed by ID ({ [id]: entity }) rather than nested arrays, preventing duplicate out-of-sync copies."
          }
        }
      ],
      "keyTakeaways": [
  ...
  },
  {
    ...
    "description": "Master Atomic Design, Component-Driven Development, Container/Presentational patterns, state architectures, and maintainable project structures.",
    "duration": "24 min",
    "level": "intermediate",
    "status": "locked",
    "isProject": false,
      ...
      "sections": [
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "// Example Feature Module Structure (features/courses/)\n// features/courses/\n// ├── components/\n// │   ├── CourseCard.tsx        # Presentational card component\n// │   ├── CourseTimeline.tsx    # Timeline roadmap visualization\n// │   └── LevelSwitcher.tsx     # Level switcher tabs\n// ├── services/\n// │   └── course.service.ts     # Business logic & API methods\n// ├── hooks/\n// │   └── useCourseProgress.ts  # Stateful custom hook\n// ├── types/\n// │   └── course.types.ts       # Domain TypeScript interfaces\n// └── index.ts                  # Public feature barrel export",
              "explanation": "In small apps, grouping by technical layer (all components in /components, all reducers in /reducers) works adequately. However, in enterprise codebases, Feature-Driven Architecture organizes code by business domain (e.g. /features/billing, /features/analytics). Each feature folder contains its own components, custom hooks, API services, and types, making domain features self-contained and easy to test or refactor.",
              "lineByLine": [
                {
                  "line": "features/courses/",
                  "explanation": "Encapsulates all domain code for courses in one unified module."
                },
                {
                  "line": "course.service.ts",
                  "explanation": "Isolates API communication and data transformations from UI rendering."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "What is the primary benefit of feature-driven architecture when a developer is tasked with deleting or refactoring a single feature?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "All components, services, and types are localized in one feature directory, so deleting or modifying the feature requires no hunting through global folders."
          }
        },
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "// 1. Presentational Component (Pure UI)\nexport function UserProfileCard({ name, role, onLogout }) {\n  return (\n    <div className=\"profile-card\">\n      <h3>{name}</h3>\n      <p>{role}</p>\n      <button onClick={onLogout}>Sign Out</button>\n    </div>\n  );\n}\n\n// 2. Container Component (Data & Logic)\nexport function UserProfileContainer() {\n  const { user, logout } = useAuth(); // Custom hook handling auth\n  if (!user) return <p>Loading...</p>;\n  return <UserProfileCard name={user.name} role={user.role} onLogout={logout} />;\n}",
              "explanation": "The Container / Presentational pattern splits components into two responsibilities: Presentational Components (focus purely on how things look, receiving data and callbacks strictly via props, with zero knowledge of APIs or global stores) and Container Components (focus on how things work, managing state, data fetching, and passing data down to presentational components).",
              "lineByLine": [
                {
                  "line": "export function UserProfileCard({ name, role, onLogout })",
                  "explanation": "Pure presentational component easy to unit-test and render in Storybook."
                },
                {
                  "line": "export function UserProfileContainer()",
                  "explanation": "Container managing business logic and providing props to the presentational UI."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "Why are presentational components easier to test in automated UI testing environments like Storybook or Jest?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "They are pure functions of their props, meaning you can render them with mock props without needing complex network or store mocks."
          }
        },
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "// design-tokens.css\n:root {\n  /* Spacing Scale (4px baseline) */\n  --space-1: 0.25rem;  /* 4px */\n  --space-2: 0.5rem;   /* 8px */\n  --space-4: 1rem;     /* 16px */\n  --space-6: 1.5rem;   /* 24px */\n  \n  /* Elevation Shadows */\n  --shadow-sm: 0 1px 2px 0 rgb(0 0 0 / 0.05);\n  --shadow-md: 0 4px 6px -1px rgb(0 0 0 / 0.1);\n  \n  /* Radii */\n  --radius-md: 0.5rem;\n}",
              "explanation": "Design systems bridge the gap between UI designers and software engineers. Design Tokens are named variables that store visual design decisions (colors, typography, elevation shadows, border radii, spacing units). When built on CSS Custom Properties or Tailwind theme extensions, design tokens enable instant rebranding and automated dark mode adaptation.",
              "lineByLine": [
                {
                  "line": "--space-4: 1rem;",
                  "explanation": "Standard 16px base spacing token ensuring consistent margins across all components."
                },
                {
                  "line": "--shadow-md:",
                  "explanation": "Standard elevation token for cards and dropdown menus."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "How do design tokens prevent visual inconsistencies in large engineering teams?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "Tokens eliminate arbitrary magic numbers (like padding: 17px or #2f3a4b) by restricting options to an approved, cohesive scale."
          }
        }
      ],
      "keyTakeaways": [
  ...
  },
  {
    ...
    "description": "Master React's declarative paradigm: Virtual DOM diffing, JSX transpilation, Fiber reconciliation architecture, and pure component rendering.",
    "duration": "25 min",
    "level": "intermediate",
    "status": "locked",
    "isProject": false,
      ...
      "sections": [
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "// Imperative (Vanilla JS) vs Declarative (React)\n// Imperative:\nconst btn = document.createElement('button');\nbtn.textContent = count > 0 ? `Count: ${count}` : 'Click Me';\nif (count > 5) btn.classList.add('highlight');\n\n// Declarative React:\nfunction CounterButton({ count, onClick }) {\n  return (\n    <button \n      className={count > 5 ? 'btn-highlight' : 'btn-standard'}\n      onClick={onClick}\n    >\n      {count > 0 ? `Count: ${count}` : 'Click Me'}\n    </button>\n  );\n}",
              "explanation": "In imperative DOM programming (vanilla JS), developers must write explicit step-by-step instructions to create, update, and remove DOM nodes. In React's declarative model, developers simply describe what the UI should look like for a given state. React handles the complex underlying DOM mutations automatically, eliminating synchronization bugs between UI and state.",
              "lineByLine": [
                {
                  "line": "function CounterButton({ count, onClick })",
                  "explanation": "Declares component accepting state and event callback via props."
                },
                {
                  "line": "className={count > 5 ? ... : ...}",
                  "explanation": "Declaratively binds CSS class based on active count value."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "Why does declarative UI programming reduce software bugs in complex applications?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "You define the UI as a direct mathematical function of state: UI = f(state). You only manage state changes, and the UI is guaranteed to remain in sync."
          }
        },
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "// JSX Syntax and its underlying React Element Object\nconst Card = ({ title, body }) => (\n  <div className=\"card\">\n    <h3>{title}</h3>\n    <p>{body}</p>\n  </div>\n);\n\n// Underlying React Element Representation in Memory:\n// {\n//   type: 'div',\n//   props: {\n//     className: 'card',\n//     children: [\n//       { type: 'h3', props: { children: title } },\n//       { type: 'p', props: { children: body } }\n//     ]\n//   }\n// }",
              "explanation": "JSX is an XML-like syntax extension for JavaScript. Build tools (Babel, SWC, esbuild) compile JSX tags into React.createElement() function calls that instantiate lightweight JavaScript objects called React Elements (the Virtual DOM). React Elements are cheap to create, inspect, and discard in memory.",
              "lineByLine": [
                {
                  "line": "type: 'div'",
                  "explanation": "Specifies HTML tag or component function to render."
                },
                {
                  "line": "props: { className: 'card', children: [...] }",
                  "explanation": "In-memory virtual representation of attributes and child elements."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "Can a browser natively understand and execute raw JSX without a compilation/transpilation step?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "No. Browsers only execute standard JavaScript. JSX must be compiled to React.createElement or the new JSX runtime by a compiler like Vite/Babel."
          }
        },
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "// Key Prop in Reconciliation\nfunction StudentList({ students }) {\n  return (\n    <ul>\n      {students.map(student => (\n        // Stable unique ID key guarantees correct DOM reuse\n        <li key={student.id}>\n          <span>{student.name}</span>\n          <input type=\"checkbox\" defaultChecked={student.enrolled} />\n        </li>\n      ))}\n    </ul>\n  );\n}",
              "explanation": "When state changes occur, React compares the new Virtual DOM tree against the previous one using a heuristic O(n) diffing algorithm based on two assumptions: two elements of different types produce different trees, and elements with stable key props identify the same entity across renders. React Fiber enables cooperative multitasking, breaking rendering into units of work that can be paused or prioritized.",
              "lineByLine": [
                {
                  "line": "<li key={student.id}>",
                  "explanation": "Provides stable, unique identity allowing React to match DOM nodes during list reordering."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "What happens during reconciliation if the root element type changes from <div> to <section>?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "React destroys the entire <div> subtree (unmounting all children and resetting state) and mounts a brand new <section> tree from scratch."
          }
        }
      ],
      "keyTakeaways": [
      ...
      "practiceExercises": [
        {
          ...
          "solutionCode": "export function NotificationList({ alerts }) {\n  return (\n    <div className=\"notification-container\">\n      {alerts.map(a => (\n        <div key={a.id} className={`alert alert--${a.type}`}>\n          <p>{a.message}</p>\n        </div>\n      ))}\n    </div>\n  );\n}"
        }
      ]
    }
  },
  {
    ...
    "description": "Master functional component architecture, TypeScript prop contracts, useState hook mechanics, controlled inputs, and lifting state up.",
    "duration": "25 min",
    "level": "intermediate",
    "status": "locked",
    "isProject": false,
      ...
      "sections": [
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "function ScoreTracker() {\n  const [score, setScore] = React.useState(0);\n\n  const handleTriplePoint = () => {\n    // Calling setScore(score + 1) 3 times would only add 1 point due to batching with stale scope\n    // Using functional updates correctly adds 3 points:\n    setScore(prev => prev + 1);\n    setScore(prev => prev + 1);\n    setScore(prev => prev + 1);\n  };\n\n  return <button onClick={handleTriplePoint}>Score: {score} (+3)</button>;\n}",
              "explanation": "React batches multiple state updates occurring inside event handlers into a single render pass for optimal performance. Because state updates are asynchronous, reading state immediately after calling setState yields the old value. Passing an updater function (setCount(prev => prev + 1)) guarantees access to the latest pending state value.",
              "lineByLine": [
                {
                  "line": "setScore(prev => prev + 1);",
                  "explanation": "Queues an updater receiving the exact pending state from the previous queue step."
                },
                {
                  "line": "Score: {score}",
                  "explanation": "Renders the final batched result after all 3 updaters complete."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "If you call setState(count + 1) twice in the same click handler with initial count = 0, what will count be on the next render?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "Count will be 1 (not 2) because both calls evaluated 0 + 1 against the stale render scope."
          }
        },
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "function UserRegistrationForm() {\n  const [formData, setFormData] = React.useState({\n    username: '',\n    email: '',\n    role: 'developer'\n  });\n\n  const handleChange = (e) => {\n    const { name, value } = e.target;\n    setFormData(prev => ({\n      ...prev,\n      [name]: value // Dynamic property computed key\n    }));\n  };\n\n  return (\n    <form>\n      <input name=\"username\" value={formData.username} onChange={handleChange} />\n      <input name=\"email\" value={formData.email} onChange={handleChange} />\n    </form>\n  );\n}",
              "explanation": "In React, controlled inputs derive their value directly from state and update state on every keystroke via onChange. Managing multi-field forms can be cleanly accomplished using a single state object and dynamic computed property names ([e.target.name]: e.target.value).",
              "lineByLine": [
                {
                  "line": "const { name, value } = e.target;",
                  "explanation": "Destructures input name attribute and current typed value."
                },
                {
                  "line": "[name]: value",
                  "explanation": "Computes property key dynamically, updating only the modified field."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "What happens if you provide a value prop to an <input> without providing an onChange handler?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "The input becomes locked and read-only; user typing will have no effect because state is never updated."
          }
        },
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "// Parent Component Managing Shared State\nfunction ProductSearchParent() {\n  const [query, setQuery] = React.useState('');\n\n  return (\n    <div className=\"search-app\">\n      {/* Sibling 1: Mutates query */}\n      <SearchInput value={query} onQueryChange={setQuery} />\n      \n      {/* Sibling 2: Reads query */}\n      <SearchResults query={query} />\n    </div>\n  );\n}",
              "explanation": "When two sibling components require access to the same state (e.g. a SearchFilter input and a ProductList display), the state is \"lifted up\" to their common parent. The parent passes the state value down to ProductList and passes an updater callback down to SearchFilter.",
              "lineByLine": [
                {
                  "line": "const [query, setQuery] = React.useState('');",
                  "explanation": "Lifts search query state to the closest common parent."
                },
                {
                  "line": "<SearchInput value={query} onQueryChange={setQuery} />",
                  "explanation": "Passes updater function to child component."
                },
                {
                  "line": "<SearchResults query={query} />",
                  "explanation": "Passes active query value to sibling component for filtering."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "What is \"Prop Drilling\" and what tool in React resolves it when state must be passed through 8 intermediate components?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "Prop Drilling is passing props through many intermediary components that don't need them. React Context API or state stores (Zustand/Redux) resolve this."
          }
        }
      ],
      "keyTakeaways": [
  ...
  },
  {
    ...
    "description": "Master React hooks lifecycle: useEffect dependencies, cleanup functions, useRef DOM references, useMemo caching, useCallback stability, and custom hooks architecture.",
    "duration": "26 min",
    "level": "intermediate",
    "status": "locked",
    "isProject": false,
      ...
      "sections": [
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "function WindowResizeTracker() {\n  const [windowWidth, setWindowWidth] = React.useState(window.innerWidth);\n\n  React.useEffect(() => {\n    const handleResize = () => setWindowWidth(window.innerWidth);\n    \n    window.addEventListener('resize\", handleResize);\n    \n    // Cleanup function removes listener when component unmounts\n    return () => {\n      window.removeEventListener('resize', handleResize);\n    };\n  }, []); // Empty array = mount/unmount only\n\n  return <p>Current Viewport Width: {windowWidth}px</p>;\n}",
              "explanation": "The useEffect hook synchronizes a React component with external systems (APIs, timers, event listeners, WebSocket connections). The dependency array determines when the effect re-runs: empty array [] (runs once on mount), with dependencies [a, b] (runs when a or b changes), and omitted (runs after every single render). Returning a function from useEffect executes cleanup before the next effect run or on unmount.",
              "lineByLine": [
                {
                  "line": "window.addEventListener('resize', handleResize);",
                  "explanation": "Attaches global window resize event listener on component mount."
                },
                {
                  "line": "return () => window.removeEventListener(...)",
                  "explanation": "Cleans up listener on component unmount, preventing memory leaks."
                },
                {
                  "line": "}, []);",
                  "explanation": "Ensures the effect runs only once when the component initially mounts."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "What happens if you start a setInterval inside useEffect without returning a clearInterval cleanup function?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "The interval timer will run indefinitely in memory, attempting to update unmounted component state and causing memory leaks."
          }
        },
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "function AutoFocusSearchInput() {\n  const inputRef = React.useRef(null);\n  const renderCount = React.useRef(0);\n\n  React.useEffect(() => {\n    // Focus the input DOM node on initial load\n    inputRef.current?.focus();\n  }, []);\n\n  renderCount.current += 1; // Track renders without triggering new renders\n\n  return (\n    <div>\n      <input ref={inputRef} placeholder=\"Search documentation...\" />\n      <p>Rendered {renderCount.current} times</p>\n    </div>\n  );\n}",
              "explanation": "useRef returns a mutable ref object whose .current property persists across the entire component lifecycle. Unlike useState, mutating ref.current does NOT trigger a re-render. It is commonly used for direct DOM node access (focusing inputs, measuring heights) and tracking mutable values like interval IDs or previous state snapshots.",
              "lineByLine": [
                {
                  "line": "const inputRef = React.useRef(null);",
                  "explanation": "Creates reference container for DOM node."
                },
                {
                  "line": "inputRef.current?.focus();",
                  "explanation": "Directly executes DOM method on the input node."
                },
                {
                  "line": "renderCount.current += 1;",
                  "explanation": "Updates persistent counter without triggering a re-render cycle."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "Why should you not write to ref.current during the main rendering phase of a component?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "Mutating refs during render makes the component impure and unpredictable; ref mutations belong inside useEffect or event handlers."
          }
        },
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "// Reusable useLocalStorage Custom Hook\nfunction useLocalStorage(key, initialValue) {\n  const [storedValue, setStoredValue] = React.useState(() => {\n    try {\n      const item = window.localStorage.getItem(key);\n      return item ? JSON.parse(item) : initialValue;\n    } catch (err) {\n      return initialValue;\n    }\n  });\n\n  const setValue = (value) => {\n    try {\n      const valueToStore = value instanceof Function ? value(storedValue) : value;\n      setStoredValue(valueToStore);\n      window.localStorage.setItem(key, JSON.stringify(valueToStore));\n    } catch (err) {\n      console.error(err);\n    }\n  };\n\n  return [storedValue, setValue];\n}",
              "explanation": "Custom hooks allow developers to extract complex stateful operations into clean, reusable functions. By adhering to the \"use\" naming convention, custom hooks leverage standard React hooks under the hood, enabling seamless state persistence, network fetching, and media query monitoring across any component.",
              "lineByLine": [
                {
                  "line": "React.useState(() => { ... })",
                  "explanation": "Lazy initial state function reads from localStorage only once on initial mount."
                },
                {
                  "line": "window.localStorage.setItem(...)",
                  "explanation": "Synchronizes updated state to browser localStorage seamlessly."
                },
                {
                  "line": "return [storedValue, setValue];",
                  "explanation": "Returns tuple mirroring standard useState API convention."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "If two different components call useLocalStorage(\"theme\", \"dark\"), do they share the exact same React state in memory?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "No. Each call to a custom hook creates an independent state instance; they only share the underlying localStorage persistence layer."
          }
        }
      ],
      "keyTakeaways": [
  ...
  },
  {
    ...
    "description": "Master SPA routing with React Router: dynamic route parameters, nested layouts with Outlet, protected routes, and code-splitting with Suspense.",
    "duration": "25 min",
    "level": "intermediate",
    "status": "locked",
    "isProject": false,
      ...
      "sections": [
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "// Layout Component with Outlet\nimport { NavLink, Outlet } from 'react-router-dom';\n\nexport function AppLayout() {\n  return (\n    <div className=\"app-container\">\n      <header className=\"global-nav\">\n        <NavLink to=\"/\" className={({ isActive }) => isActive ? 'link-active' : 'link'}>\n          Dashboard\n        </NavLink>\n        <NavLink to=\"/courses\" className={({ isActive }) => isActive ? 'link-active' : 'link'}>\n          Courses\n        </NavLink>\n      </header>\n      \n      {/* Child route components render here */}\n      <main className=\"content-area\">\n        <Outlet />\n      </main>\n    </div>\n  );\n}",
              "explanation": "React Router maps browser URL paths to React components. Nested routes enable parent layout components (containing universal headers and sidebars) to persist while dynamically swapping out child views inside an <Outlet /> element. This avoids unnecessary re-rendering of shared layout chrome.",
              "lineByLine": [
                {
                  "line": "<NavLink to=\"/courses\" ...>",
                  "explanation": "Provides built-in active state styling awareness for navigation links."
                },
                {
                  "line": "<Outlet />",
                  "explanation": "Placeholder component rendering matched child route components."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "What component is used in React Router to redirect a user from legacy path /old-courses to /courses?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "<Route path=\"/old-courses\" element={<Navigate to=\"/courses\" replace />} />"
          }
        },
        {
          ...
          "codeSnippets": [
            {
              ...
              "explanation": "Dynamic route parameters (path=\"courses/:courseId\") capture variable URL segments and expose them via the useParams() hook. URL query strings (?level=beginner&task=3) are read and modified via the useSearchParams() hook, enabling shareable, bookmarkable application states.",
              "lineByLine": [
                {
                  "line": "const { courseId } = useParams();",
                  "explanation": "Extracts dynamic URL segment :courseId from the active route."
                },
                {
                  "line": "const [searchParams, setSearchParams] = useSearchParams();",
                  "explanation": "Hook providing read and write access to URL query string parameters."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "Why is storing UI tab selection in URL search parameters (?tab=quiz) better than storing it purely in local component useState?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "URL parameters allow users to bookmark, refresh, and share exact page views and active tabs directly."
          }
        },
        {
          ...
          "codeSnippets": [
            {
              ...
              "explanation": "Protected routes prevent unauthorized users from accessing sensitive pages (like user profiles or admin dashboards). A protected route wrapper checks user authentication status; if authenticated, it renders the child content; otherwise, it redirects the user to the login screen with a state redirect parameter.",
              "lineByLine": [
                {
                  "line": "if (loading) return ...",
                  "explanation": "Prevents premature redirect while authentication status is verifying."
                },
                {
                  "line": "<Navigate to=\"/login\" state={{ from: location }} replace />",
                  "explanation": "Redirects unauthenticated user while saving current path for post-login redirection."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "What does the replace prop on <Navigate /> do to the browser history stack?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "replace prevents the redirected page from being saved in the history stack, so clicking the browser Back button does not trigger an infinite redirect loop."
          }
        }
      ],
      "keyTakeaways": [
      ...
      "practiceExercises": [
        {
          ...
          "solutionCode": "export function ProtectedAdminRoute({ children }) {\n  const { user } = useAuth();\n  if (!user || user.role !== \"admin\") {\n    return <Navigate to=\"/unauthorized\" replace />;\n  }\n  return children;\n}"
        }
      ]
    }
  },
  {
    ...
    "description": "Master web performance optimization: code splitting, bundle analysis, memoization profiling, WCAG auditing with Axe, and Lighthouse optimization.",
    "duration": "25 min",
    "level": "intermediate",
    "status": "locked",
    "isProject": false,
      ...
      "sections": [
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "<!-- Optimizing LCP and CLS in HTML/CSS -->\n<!-- 1. Preload Hero Image -->\n<link rel=\"preload\" as=\"image\" href=\"/hero.webp\" fetchpriority=\"high\">\n\n<!-- 2. CSS aspect-ratio prevents CLS layout shift -->\n<style>\n  .hero-media {\n    width: 100%;\n    aspect-ratio: 16 / 9;\n    background-color: #f1f5f9; /* Placeholder background */\n  }\n</style>",
              "explanation": "Core Web Vitals represent Google's metrics for real-world user experience. LCP (Largest Contentful Paint < 2.5s) measures when the main hero element is rendered; INP (Interaction to Next Paint < 200ms) measures responsiveness to user clicks and taps; CLS (Cumulative Layout Shift < 0.1) measures visual stability. Remediation techniques include preloading hero images, avoiding blocking scripts, and reserving layout space.",
              "lineByLine": [
                {
                  "line": "fetchpriority=\"high\"",
                  "explanation": "Signals browser to prioritize this image download above all standard images."
                },
                {
                  "line": "aspect-ratio: 16 / 9;",
                  "explanation": "Reserves exact vertical space before image bytes arrive, eliminating CLS."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "What tool in Chrome DevTools allows simulating low-end mobile CPUs and 3G network throttling?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "The \"CPU Throttling\" (4x/6x slowdown) and \"Network Throttling\" (Fast 3G / Slow 3G) dropdowns in DevTools."
          }
        },
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "// Memoized Component with Stable Props\ninterface ListItemProps {\n  item: { id: string; name: string };\n  onDelete: (id: string) => void;\n}\n\n// React.memo skips re-render if props haven't changed\nexport const ListItem = React.memo<ListItemProps>(({ item, onDelete }) => {\n  console.log('Rendering ListItem ID:', item.id);\n  return (\n    <li>\n      <span>{item.name}</span>\n      <button onClick={() => onDelete(item.id)}>Delete</button>\n    </li>\n  );\n});",
              "explanation": "The React DevTools Profiler records flamegraphs of component render durations. Common causes of wasted re-renders include creating new object references or inline arrow functions passed to memoized children. Wrapping child components in React.memo() and stabilizing prop functions with useCallback() eliminates unnecessary subtree re-renders.",
              "lineByLine": [
                {
                  "line": "React.memo<ListItemProps>(...)",
                  "explanation": "Wraps component with shallow prop comparison check."
                },
                {
                  "line": "onDelete: (id: string) => void;",
                  "explanation": "Parent must pass stable useCallback function for React.memo to work."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "Why will React.memo fail to prevent re-renders if the parent passes an inline function like onDelete={() => handleDelete(item.id)}?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "Every parent render instantiates a new function reference pointer, failing the shallow equality check (newFn !== oldFn)."
          }
        },
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "// Initializing axe-core accessibility auditing in development\n// import React from 'react';\n// import ReactDOM from 'react-dom';\n\nif (process.env.NODE_ENV !== 'production') {\n  import('@axe-core/react').then(axe => {\n    // axe.default(React, ReactDOM, 1000);\n    console.log('Accessibility auditing active.');\n  });\n}",
              "explanation": "Accessibility is a fundamental requirement for production applications. Integrating automated tools like @axe-core/react in development flags missing ARIA labels, low contrast text, and keyboard traps directly in the browser console. Running Lighthouse audits verifies performance, SEO, accessibility, and best practices compliance.",
              "lineByLine": [
                {
                  "line": "if (process.env.NODE_ENV !== 'production')",
                  "explanation": "Ensures accessibility auditing tool runs strictly in development."
                },
                {
                  "line": "axe.default(React, ReactDOM, 1000)",
                  "explanation": "Debounces DOM scans to log a11y violations to console 1s after render."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "What is the WCAG minimum color contrast requirement for standard body text?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "A contrast ratio of at least 4.5:1 between text and background color."
          }
        }
      ],
      "keyTakeaways": [
  ...
  },
  {
    ...
    "description": "Master Vite development server architecture, Rollup production bundling, PostCSS/Tailwind configuration, environment variables, and asset hashing.",
    "duration": "24 min",
    "level": "intermediate",
    "status": "locked",
    "isProject": false,
      ...
      "sections": [
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "// Accessing Environment Variables in Vite (Client-side)\n// .env file:\n// VITE_API_BASE_URL=https://api.skillora.ai\n// SECRET_DB_KEY=supersecret (Not exposed to client)\n\nexport const API_URL = import.meta.env.VITE_API_BASE_URL;\nexport const IS_DEV = import.meta.env.DEV; // Boolean true in dev mode\n\nconsole.log(`Connected to API: ${API_URL} (Dev Mode: ${IS_DEV})`);",
              "explanation": "Legacy bundlers (Webpack, Parcel) pre-bundle the entire application before starting the local development server. As applications grow, startup and hot-reload times degrade to minutes. Vite transforms this by serving source code over native browser ES Modules. Files are compiled on-demand using esbuild (written in Go), providing instant server startup (<300ms) and sub-50ms Hot Module Replacement (HMR) regardless of app size.",
              "lineByLine": [
                {
                  "line": "import.meta.env.VITE_API_BASE_URL",
                  "explanation": "Securely reads environment variable prefixed with VITE_."
                },
                {
                  "line": "import.meta.env.DEV",
                  "explanation": "Built-in Vite boolean indicating whether code is running in dev mode."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "What happens if you create an environment variable DATABASE_PASSWORD=xyz in a .env file and try to access import.meta.env.DATABASE_PASSWORD in Vite?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "It returns undefined, safely protecting sensitive secrets from being leaked into the client bundle."
          }
        },
        {
          ...
          "codeSnippets": [
            {
              ...
              "explanation": "Tailwind CSS is a utility-first CSS framework that scans HTML, JSX, and TSX files for class names, generating only the CSS classes actually used in the project. When integrated with PostCSS and Autoprefixer, Vite generates micro-sized, production-ready stylesheets with vendor prefixes applied automatically.",
              "lineByLine": [
                {
                  "line": "content: ['./src/**/*.{js,ts,jsx,tsx}']",
                  "explanation": "Tells Tailwind compiler where to scan for utility class usage."
                },
                {
                  "line": "colors: { brand: { ... } }",
                  "explanation": "Extends default color palette with custom brand design tokens."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "Why does Tailwind CSS produce virtually no stylesheet size growth as an application scales to hundreds of components?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "Because the same utility classes are reused repeatedly across components, meaning new UI components add 0 bytes to the compiled CSS."
          }
        },
        {
          ...
          "codeSnippets": [
            {
              "language": "typescript",
              "code": "// Rollup Manual Chunks Configuration in vite.config.ts\nexport default defineConfig({\n  build: {\n    rollupOptions: {\n      output: {\n        manualChunks: {\n          // Split heavy vendor libraries into a separate cached bundle\n          'vendor-react': ['react', 'react-dom', 'react-router-dom'],\n          'vendor-charts': ['chart.js']\n        }\n      }\n    }\n  }\n});",
              "explanation": "When running npm run build (vite build), Vite invokes Rollup to compile, minify, and bundle your application. Rollup performs dead-code elimination (tree-shaking) and generates content-hashed filenames (e.g. index-B4d9f1a.js). If a file's code changes, its hash changes, allowing CDN caches to serve assets indefinitely while ensuring instant cache busting on deployment.",
              "lineByLine": [
                {
                  "line": "manualChunks: { ... }",
                  "explanation": "Instructs bundler to group third-party libraries into dedicated cached bundles."
                },
                {
                  "line": "'vendor-react': ['react', ...]",
                  "explanation": "Creates long-lived cached vendor chunk that rarely changes between deploys."
                }
              ]
            }
          ],
          "miniPractice": {
            "question": "What is the command to preview the production build output locally before deploying to production?",
            "options": [
              "Option A",
              "Option B",
              "Option C",
            ...
            "correctAnswer": 0,
            "explanation": "npm run preview (or npx vite preview), which boots a local static server serving the dist/ folder."
          }
        }
      ],
      "keyTakeaways": [
      ...
      "practiceExercises": [
        {
          ...
          "solutionCode": "import { defineConfig } from \"vite\";\nimport react from \"@vitejs/plugin-react\";\nimport path from \"path\";\nexport default defineConfig({\n  plugins: [react()],\n  resolve: { alias: { \"@\": path.resolve(__dirname, \"./src\") } },\n  build: { outDir: \"dist\", sourcemap: false }\n});"
        }
      ]
    }
  },
      ...
      "deliverables": [
        ...
        },
        {
          ...
          "criteria": [
            ...
            "Tailwind custom tokens configured",
        ...
        },
        {
          ...
          "criteria": [
            "Focus trap on open",
            "ESC key closing",
            "aria-labelledby and role=\"dialog\""
          ],
        ...
        },
        {
          ...
          "criteria": [
            "Minimum 8 passing unit tests",
            "User event interactions tested",
            "Mock API handlers"
          ],
      ...
      "evaluationRubric": [
        {
          ...
          "weight": "25%",
          "criteria": "Feature-driven layout, strict TypeScript interfaces, clean code organization."
        },
        {
          "category": "React & State Management",
          "weight": "25%",
          "criteria": "Optimistic UI updates, custom hooks, proper dependency arrays, Context API."
        },
        {
          "category": "Routing & UI Polish",
          "weight": "25%",
          "criteria": "Nested routes, responsive Tailwind layout, accessible modal dialogs, debounced search."
        },
        {
          "category": "Testing & Production Quality",
          "weight": "25%",
          "criteria": "Vitest unit tests, clean Git history, live deployment with Lighthouse 95+ score."
        }
      ]
    }
  },
