...
const targetFile = path.join(__dirname, '../src/features/roadmap/data/youtube-ads/youtubeAdsIntermediate.data.ts');
const targetDir = path.dirname(targetFile);
if (!fs.existsSync(targetDir)) {
  fs.mkdirSync(targetDir, { recursive: true });
}

// 30 High-Quality Intermediate MCQs with balanced distribution (8 A, 7 B, 8 C, 7 D = 30 total)
...
// 14 Comprehensive Theory Modules for Intermediate
const INTERMEDIATE_MODULES = [
  {
    ...
    tags: ['Architecture', 'Account Structure', 'Campaign Scaling', 'Segmentation'],
    lessonContent: {
...
const accountPlan = {
  ...
  tier2Warm: {
    ...
    exclusions: ["Customer_Match_180D"]
          ...
          hints: ['Check mutual exclusion arrays.'],
          validationChecklist: [
  ...
  },
  {
    ...
    isProject: false,
    isFinalAssessment: false,
    tags: ['GTM', 'Google Tag', 'Conversion Tracking', 'Enhanced Conversions', 'EVC'],
    lessonContent: {
...
const trackingConfig = {
  ...
  attributionWindows: {
    ...
    viewThroughDays: 1
          ...
          hints: ['Standard EVC window is 3 days.'],
          validationChecklist: [
  ...
  },
  {
    ...
    isProject: false,
    isFinalAssessment: false,
    tags: ['Audience Research', 'Intent Mapping', 'Competitor Intelligence', 'Keyword Mining'],
    lessonContent: {
...
const copywriterIntentMatrix = {
  ...
  tier2Solution: {
    ...
    hook: "Here is the 3-sentence email template that booked 42 calls last month."
          ...
          hints: ['Tier 1 addresses competitor dissatisfaction; Tier 2 addresses category outcome.'],
          validationChecklist: [
  ...
  },
  {
    ...
    isProject: false,
    isFinalAssessment: false,
    tags: ['Custom Segments', 'Search Intent', 'URL Graph', 'App Targeting'],
    lessonContent: {
...
const customSegmentPlan = {
  ...
  optimizedTargetingInitialState: false // Disabled for seed testing
          ...
          hints: ['Seed testing requires optimizedTargeting = false.'],
          validationChecklist: [
  ...
  },
  {
    ...
    isProject: false,
    isFinalAssessment: false,
    tags: ['First-Party Data', 'Customer Match', 'Remarketing', 'Sequencing'],
    lessonContent: {
...
const sequencePlan = {
  ...
  retargetingStage2: {
    ...
    exclusion: "All_Customers"
          ...
          hints: ['Buyer suppression is mandatory across all retargeting stages.'],
          validationChecklist: [
  ...
  },
  {
    ...
    isProject: false,
    isFinalAssessment: false,
    tags: ['Scriptwriting', 'Direct Response', 'Creative Strategy', 'UGC', 'Hooks'],
    lessonContent: {
...
const masterScript = {
  ...
  directiveCta60to75s: "Click the button below to claim your free 14-day trial. (10s holding card)"
          ...
          hints: ['Ensure mechanism and social proof are explicitly defined.'],
          validationChecklist: [
  ...
  },
  {
    ...
    isProject: false,
    isFinalAssessment: false,
    tags: ['Hooks', 'Retention Psychology', 'Pattern Interrupts', 'Cognitive Momentum'],
    lessonContent: {
...
const retentionIssue = {
  ...
  editFixes: [
    ...
    { timestamp: 25, action: "Add whoosh sound effect and animated customer quote" }
          ...
          hints: ['Pacing fixes eliminate static talking head fatigue.'],
          validationChecklist: [
  ...
  },
  {
    ...
    isProject: false,
    isFinalAssessment: false,
    tags: ['YouTube Shorts', 'Vertical Video', 'Mobile Media Buying', 'Safe Zones'],
    lessonContent: {
...
const shortsPlan = {
  ...
  cta: "Click the Shop Now button at the bottom of your screen!"
          ...
          hints: ['Captions must sit in the central 50% of the vertical canvas.'],
          validationChecklist: [
  ...
  },
  {
    ...
    isProject: false,
    isFinalAssessment: false,
    tags: ['Video Action Campaigns', 'Lead Generation', 'Lead Forms', 'Webhooks', 'CRM'],
    lessonContent: {
...
const leadGenConfig = {
  ...
  webhookEndpoint: "https://api.mycrm.com/v1/leads/google-ads"
          ...
          hints: ['Higher Intent mode ensures qualified submissions.'],
          validationChecklist: [
  ...
  },
  {
    ...
    isProject: false,
    isFinalAssessment: false,
    tags: ['Smart Bidding', 'Target CPA', 'Target ROAS', 'Scaling', 'Budget Management'],
    lessonContent: {
...
const scalingPlan = {
  ...
  horizontalExpansionPools: 3 // Add 3 new ad groups at $150/day each
          ...
          hints: ['250 * 1.2 = 300; 300 * 1.2 = 360; 360 * 1.2 = 432.'],
          validationChecklist: [
  ...
  },
  {
    ...
    isProject: false,
    isFinalAssessment: false,
    tags: ['Experiments', 'A/B Testing', 'Statistical Significance', 'Creative Testing'],
    lessonContent: {
...
const experimentPlan = {
  ...
  treatment: { hook: "Curiosity Open Loop", body: "SaaS Demo V1", cta: "Free Trial Link" }
          ...
          hints: ['Single-variable isolation is required.'],
          validationChecklist: [
  ...
  },
  {
    ...
    isProject: false,
    isFinalAssessment: false,
    tags: ['Frequency Capping', 'Reach Curves', 'Audience Fatigue', 'Incremental Reach'],
    lessonContent: {
...
const campaignMetrics = {
  ...
  proposedWeeklyCap: 4
          ...
          hints: ['Avg frequency = 400,000 / 80,000 = 5.0.'],
          validationChecklist: [
  ...
  },
  {
    ...
    isProject: false,
    isFinalAssessment: false,
    tags: ['GA4', 'Attribution Modeling', 'Looker Studio', 'Assisted Conversions', 'Reporting'],
    lessonContent: {
...
const attributionData = {
  ...
  dataDrivenCpa: 40   // $4000 / 100
          ...
          hints: ['Assistance multiplier = 120 / 40 = 3.0x.'],
          validationChecklist: [
  ...
  },
  {
    ...
    isProject: false,
    isFinalAssessment: false,
    tags: ['Brand Lift', 'Search Lift', 'Incrementality', 'Surveys'],
    lessonContent: {
...
const brandLiftStudy = {
  ...
  minimumSpendThresholdMet: true
          ...
          hints: ['Brand Lift requires competitor options for survey validity.'],
          validationChecklist: [
  ...
  },
  {
    ...
    isProject: true,
    isFinalAssessment: false,
    tags: ['Intermediate Capstone', 'Full-Funnel Architecture', 'GTM Tracking', 'Scaling Blueprint'],
    projectDetails: {
...
const INTERMEDIATE_FINAL_ASSESSMENT_TASK = {
  id: 'yt-int-exam',
...
// Combine all intermediate tasks into one exportable array
const ALL_INTERMEDIATE_TASKS = [
  ...INTERMEDIATE_MODULES,
  INTERMEDIATE_FINAL_ASSESSMENT_TASK
];

// Generate TypeScript Output
const tsOutput = `import { Task, QuizQuestion } from '../../types/roadmap.types';

export const YOUTUBE_ADS_INTERMEDIATE_FINAL_ASSESSMENT: QuizQuestion[] = ${JSON.stringify(INTERMEDIATE_ASSESSMENT, null, 2)};

export const YOUTUBE_ADS_INTERMEDIATE_TASKS: Task[] = ${JSON.stringify(ALL_INTERMEDIATE_TASKS, null, 2)};
`;

fs.writeFileSync(targetFile, tsOutput, 'utf-8');
console.log(`✅ Successfully generated: ${targetFile} (${ALL_INTERMEDIATE_TASKS.length} tasks, ${INTERMEDIATE_ASSESSMENT.length} MCQs)`);
