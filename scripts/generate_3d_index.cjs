...
const targetFile = path.join(__dirname, '..', 'src', 'features', 'roadmap', 'data', '3d-animation', 'index.ts');

const content = `import { CourseLevel, LevelProgress, CourseProgressState } from '../../types/roadmap.types';
