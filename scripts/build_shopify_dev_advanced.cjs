...
const targetFile = path.join(__dirname, '../src/features/roadmap/data/shopify-developer/shopifyDeveloperAdvanced.data.ts');
const targetDir = path.dirname(targetFile);
if (!fs.existsSync(targetDir)) {
  fs.mkdirSync(targetDir, { recursive: true });
}

// 40 High-Quality Advanced MCQs with balanced distribution (10 A, 10 B, 10 C, 10 D = 40)
...
const ADVANCED_MODULES = [
  {
    ...
    requiresQuiz: false,
    resources: [
      { id: 'res-adv-app-01', title: 'Enterprise App Architecture Guide', type: 'documentation', url: 'https://shopify.dev/docs/apps/getting-started' }
    ],
    lessonContent: {
      ...
      sections: [
        {
          ...
          codeSnippets: [
            formatSnippet(
              ...
              'Authenticated Remix Route with Admin GraphQL Client',
...
export default function InventoryRoute() {
        ...
        <Layout.Section>
          <Card>
            ...
            />
              ...
              'Authenticated Remix loader verifying session tokens and querying Admin GraphQL directly.'
            )
          ],
  ...
  },
  {
    ...
    requiresQuiz: false,
    resources: [
      { id: 'res-adv-admin-01', title: 'Bulk Operations Guide', type: 'documentation', url: 'https://shopify.dev/docs/api/admin-graphql/latest/queries/bulkOperationRunQuery' }
    ],
    lessonContent: {
      ...
      sections: [
        {
          ...
          codeSnippets: [
            formatSnippet(
              'typescript',
              'server/bulk-operation-runner.ts',
              'Initiating & Streaming GraphQL Bulk Operations',
...
export function streamJsonLines(downloadUrl: string, onRow: (row: any) => void) {
  https.get(downloadUrl, (response) => {
    ...
    rl.on('close', () => {
      console.log('Completed streaming bulk JSONL data export.');
              ...
              'Asynchronous Bulk Operation query initiation and streaming JSONL line parser.'
            )
          ],
  ...
  },
  {
    ...
    requiresQuiz: false,
    resources: [
      { id: 'res-adv-hl-01', title: 'Headless Commerce Architecture', type: 'documentation', url: 'https://shopify.dev/docs/custom-storefronts' }
    ],
    lessonContent: {
      ...
      sections: [
        {
          ...
          codeSnippets: [
            formatSnippet(
              'typescript',
              'lib/shopify-storefront-service.ts',
              'Enterprise Headless Storefront Service with Context Support',
              `export class HeadlessStorefrontService {
  ...
  async getLocalizedProduct(handle: string, country: string = 'US', language: string = 'EN') {
    ...
    return await this.execute<{ product: any }>(QUERY, { handle, country, language });
              ...
              'Decoupled storefront service with Incremental Static Regeneration (ISR) and localized @inContext support.'
            )
          ],
  ...
  },
  {
    ...
    requiresQuiz: false,
    resources: [
      { id: 'res-adv-hyd-01', title: 'Shopify Hydrogen Documentation', type: 'documentation', url: 'https://shopify.dev/docs/custom-storefronts/hydrogen' }
    ],
    lessonContent: {
      ...
      sections: [
        {
          ...
          codeSnippets: [
            formatSnippet(
              ...
              'Hydrogen Product Route with Oxygen Subrequest Caching',
...
export default function ProductRoute() {
  ...
  return (
    <div className="product-page max-w-5xl mx-auto py-12 px-4">
      ...
      <div className="prose mt-6" dangerouslySetInnerHTML={{ __html: product.descriptionHtml }} />
              ...
              'Hydrogen route utilizing context.storefront with CacheShort edge caching.'
            )
          ],
  ...
  },
  {
    ...
    requiresQuiz: false,
    resources: [
      { id: 'res-adv-chk-01', title: 'Checkout Extensibility Developer Guide', type: 'documentation', url: 'https://shopify.dev/docs/apps/checkout' }
    ],
    lessonContent: {
      ...
      sections: [
        {
          ...
          codeSnippets: [
            formatSnippet(
              'graphql',
              'mutations/update-checkout-branding.graphql',
              'Checkout Branding API Mutation',
              `mutation UpdateCheckoutThemeBranding($checkoutProfileId: ID!) {
  checkoutBrandingUpsert(
    ...
    userErrors {
      ...
      message
              ...
              'Customizing global checkout colors, typography, and corner radius using the Checkout Branding API.'
            )
          ],
  ...
  },
  {
    ...
    requiresQuiz: false,
    resources: [
      { id: 'res-adv-func-01', title: 'Shopify Functions Specification', type: 'documentation', url: 'https://shopify.dev/docs/apps/functions' }
    ],
    lessonContent: {
      ...
      sections: [
        {
          ...
          codeSnippets: [
            formatSnippet(
              'graphql',
              'extensions/vip-discount-function/input.graphql',
              'Shopify Function Input GraphQL Query',
              `query Input {
  cart {
    buyerIdentity {
      customer {
      ...
      merchandise {
        ... on ProductVariant {
          id
              ...
              'Declaring the exact cart and customer tag data required by the function.'
            ),
            formatSnippet(
              'rust',
              'extensions/vip-discount-function/src/main.rs',
              'Rust Shopify Function Implementation',
...
fn function(input: input::ResponseData) -> Result<output::FunctionResult> {
    ...
    discounts: vec![output::Discount {
      ...
      value: output::Value::Percentage(output::Percentage {
        value: 20.0,
              ...
              'Rust WebAssembly function calculating a 20% discount for verified VIP customers.'
            )
          ],
  ...
  },
  {
    ...
    requiresQuiz: false,
    resources: [
      { id: 'res-adv-auth-01', title: 'Token Exchange and Session Token Architecture', type: 'documentation', url: 'https://shopify.dev/docs/apps/auth/oauth/session-tokens' }
    ],
    lessonContent: {
...
export async function verifyShopifySessionToken(token: string, expectedApiKey: string): Promise<any> {
    ...
    jwt.verify(
      ...
      (err, decoded: any) => {
        ...
        resolve({ shop, userId: decoded.sub, exp: decoded.exp });
              ...
              'Verifying App Bridge session tokens against Shopify JWKS certificates.'
            )
          ],
  ...
  },
  {
    ...
    requiresQuiz: false,
    resources: [
      { id: 'res-adv-wh-sec-01', title: 'Webhook Security & Replay Prevention', type: 'documentation', url: 'https://shopify.dev/docs/apps/webhooks' }
    ],
    lessonContent: {
      ...
      sections: [
        {
          ...
          codeSnippets: [
            formatSnippet(
              'typescript',
              'server/secure-webhook-guard.ts',
              'Advanced Webhook Ingestion Guard with Replay Defense',
...
export function secureWebhookGuard(secret: string) {
  return (req: Request, res: Response, next: NextFunction) => {
    ...
    next();
              ...
              'Middleware enforcing HMAC verification and timestamp freshness validation.'
            )
          ],
  ...
  },
  {
    ...
    requiresQuiz: false,
    resources: [
      { id: 'res-adv-db-01', title: 'Multi-Tenant Database Design Patterns', type: 'documentation', url: 'https://shopify.dev/docs/apps/best-practices/performance' }
    ],
    lessonContent: {
      ...
      sections: [
        {
          ...
          codeSnippets: [
            formatSnippet(
              ...
              'PostgreSQL Multi-Tenant Schema with RLS and Indexes',
...
CREATE INDEX idx_store_configs_store_id ON store_configs(store_id);`,
              'Normalized relational schema with composite indexes and cascade deletion rules.'
            )
          ],
  ...
  },
  {
    ...
    requiresQuiz: false,
    resources: [
      { id: 'res-adv-queue-01', title: 'Reliable Background Processing Architecture', type: 'documentation', url: 'https://shopify.dev/docs/apps/best-practices/performance' }
    ],
    lessonContent: {
      ...
      sections: [
        {
          ...
          codeSnippets: [
            formatSnippet(
              'typescript',
              'server/queues/queue-manager.ts',
              'Multi-Tier Priority Queue Manager',
...
export async function enqueueCatalogSync(shop: string, productIds: string[]) {
  return await bulkQueue.add(
    ...
    { jobId: \`sync:\${shop}:\${Date.now()}\` }
              ...
              'Configuring separated priority queues with Redis connection pooling and retention policies.'
            )
          ],
  ...
  },
  {
    ...
    requiresQuiz: false,
    resources: [
      { id: 'res-adv-perf-01', title: 'Shopify Rate Limits and Cost Optimization', type: 'documentation', url: 'https://shopify.dev/docs/api/usage/rate-limits' }
    ],
    lessonContent: {
      ...
      sections: [
        {
          ...
          codeSnippets: [
            formatSnippet(
              'typescript',
              'server/adaptive-client.ts',
              'Adaptive GraphQL Rate-Limit Throttler',
              `export class AdaptiveShopifyClient {
  private client: any;
  ...
  async executeWithThrottling(query: string, variables: any = {}) {
    ...
    throw new Error('Max GraphQL query attempts exceeded due to persistent rate limiting.');
              ...
              'Client monitoring throttleStatus to pause proactively before hitting 429 errors.'
            )
          ],
  ...
  },
  {
    ...
    requiresQuiz: false,
    resources: [
      { id: 'res-adv-test-01', title: 'Testing Shopify Apps and Extensions', type: 'documentation', url: 'https://shopify.dev/docs/apps/tools/cli/testing' }
    ],
    lessonContent: {
      ...
      sections: [
        {
          ...
          codeSnippets: [
            formatSnippet(
              'typescript',
              'tests/e2e/inventory-dashboard.spec.ts',
              'Playwright E2E Test for Embedded Shopify App',
...
test.describe('Shopify Inventory App E2E Tests', () => {
  ...
  test('Dashboard loads inventory table and triggers sync toast', async ({ page }) => {
    ...
    await expect(toast).toBeVisible();
              ...
              'Automated Playwright test verifying Polaris table rendering and button interactions.'
            )
          ],
  ...
  },
  {
    ...
    requiresQuiz: false,
    resources: [
      { id: 'res-adv-rev-01', title: 'Shopify App Store Review Guidelines', type: 'documentation', url: 'https://shopify.dev/docs/apps/store/requirements' }
    ],
    lessonContent: {
...
export function productionSecurityHeaders(req: Request, res: Response, next: NextFunction) {
  ...
  next();
              ...
              'Production Express middleware applying required CSP frame-ancestors and security headers.'
            )
          ],
  ...
  },
  {
    ...
    requiresQuiz: false,
    resources: [
      { id: 'res-adv-cap-01', title: 'Advanced Capstone Specification', type: 'documentation', url: 'https://shopify.dev/docs/apps' }
    ],
    lessonContent: {
      ...
      sections: [
        {
          ...
          codeSnippets: [
            formatSnippet(
              'typescript',
              'platform-architecture-summary.ts',
              'Advanced Capstone Platform Component Blueprint',
              `/**
...
export const CAPSTONE_SYSTEM_MANIFEST = {
  ...
  extensionTypes: ["checkout_ui_extension", "cart_transform_function", "theme_app_extension"]
              ...
              'High-level architectural blueprint for the Advanced Capstone Platform.'
            )
          ],
...
// Project Tasks (Advanced has 2 projects: Project 1 + Capstone Project 2)
    ...
    deliverables: [
      {
        ...
        checklist: ['Target placement definition', 'User interaction state machine', 'Security boundary documentation']
      },
      {
        id: 'del-adv1-02',
        ...
        checklist: ['Banner and BlockStack layout', 'Pre-purchase upsell action hook', 'Responsive rendering across mobile checkouts']
      },
      {
        id: 'del-adv1-03',
        ...
        checklist: ['Atomic cart line addition', 'Checkout custom attribute binding', 'Loading and disabled states during mutation']
      },
      {
        id: 'del-adv1-04',
        ...
        checklist: ['Cart line cost selection', 'Customer tag queries', 'Valid GraphQL schema compilation']
      },
      {
        id: 'del-adv1-05',
        ...
        checklist: ['Clean algorithm implementation', 'Zero external network dependencies', 'Valid FunctionResult return output']
      },
      {
        id: 'del-adv1-06',
        ...
        checklist: ['Brand color configuration', 'Font family and size definitions', 'Consistent design system styling']
      },
      {
        id: 'del-adv1-07',
        ...
        checklist: ['Valid extension TOML manifest', 'Local CLI preview verified', 'Theme Editor block placement tested']
      },
      {
        id: 'del-adv1-08',
        ...
        checklist: ['Test with VIP customer tags', 'Test with non-VIP standard carts', 'Edge case tests (empty cart)']
      },
      {
        id: 'del-adv1-09',
        ...
        checklist: ['CLI deployment execution', 'App version verification in Partner Dashboard', 'Live store checkout verification']
      },
      {
        id: 'del-adv1-10',
        ...
        checklist: ['Comprehensive setup guide', 'Bogus Gateway test transaction IDs', 'Performance execution logs (<5ms)']
      }
    ]
  }
};

const ADVANCED_CAPSTONE_PROJECT = {
    ...
    deliverables: [
      {
        ...
        checklist: ['Problem statement and market validation', 'Detailed functional requirements matrix', 'Success metrics and SLA targets']
      },
      {
        id: 'del-cap-02',
        ...
        checklist: ['Complete component topology', 'Data ingestion and processing flowcharts', 'Security and network boundaries']
      },
      {
        id: 'del-cap-03',
        ...
        checklist: ['Prisma schema with foreign keys', 'Row-Level Security (RLS) policies', 'Optimized composite index design']
      },
      {
        id: 'del-cap-04',
        ...
        checklist: ['Inventory and catalog queries', 'Bulk operation export pipelines', 'userErrors validation routines']
      },
      {
        id: 'del-cap-05',
        ...
        checklist: ['Localized cart mutations', 'Product catalog queries with filters', 'Customer access token management']
      },
      {
        id: 'del-cap-06',
        ...
        checklist: ['RS256 JWT session token verifier', 'Offline token encryption with AES-256', 'Automated token refresh handling']
      },
      {
        id: 'del-cap-07',
        ...
        checklist: ['Declared scope matrix', 'Scope upgrade redirect triggers', 'Zero unnecessary permissions requested']
      },
      {
        id: 'del-cap-08',
        ...
        checklist: ['Sub-20ms 200 OK acknowledgment', 'HMAC SHA-256 cryptographic guard', 'Mandatory GDPR compliance webhooks']
      },
      {
        id: 'del-cap-09',
        ...
        checklist: ['BullMQ worker pool with concurrency', 'Job progress telemetry reporting', 'Dead Letter Queue (DLQ) handler']
      },
      {
        id: 'del-cap-10',
        ...
        checklist: ['Exponential backoff with jitter', 'Automated job retry caps', 'Dead Letter Queue alert notifications']
      },
      {
        id: 'del-cap-11',
        ...
        checklist: ['Content Security Policy (CSP) headers', 'Timing-safe HMAC comparisons', 'Input sanitization and parameterized queries']
      },
      {
        id: 'del-cap-12',
        ...
        checklist: ['100% passing Vitest unit tests', 'Playwright E2E suite covering critical flows', 'Mocked Shopify API test harness']
      },
      {
        id: 'del-cap-13',
        ...
        checklist: ['Adaptive rate limit throttler', 'Redis response caching with TTL', 'Sub-second dashboard TTFB']
      },
      {
        id: 'del-cap-14',
        ...
        checklist: ['Production multi-stage Dockerfile', 'GitHub Actions test & deploy workflow', 'Zero-downtime rolling deployment']
      },
      {
        id: 'del-cap-15',
        ...
        checklist: ['Sentry exception capturing configured', 'Structured Winston/Pino JSON logs', 'Health check API endpoint (/healthz)']
      },
      {
        id: 'del-cap-16',
        ...
        checklist: ['Polaris UI consistency verified', 'Mandatory privacy webhooks verified', 'Empty states and onboarding tested']
      },
      {
        id: 'del-cap-17',
        ...
        checklist: ['Step-by-step local setup instructions', 'Complete environment variable directory', 'API documentation references']
      },
      {
        id: 'del-cap-18',
        ...
        checklist: ['Live demo walkthrough script', 'Sample data seeding utility', 'Bogus payment test verification record']
      }
    ]
  }
};
...
export const SHOPIFY_DEV_ADVANCED_ASSESSMENT: QuizQuestion[] = ${JSON.stringify(ADVANCED_ASSESSMENT, null, 2)};

export const SHOPIFY_DEV_ADVANCED_TASKS: Task[] = ${JSON.stringify(ALL_ADVANCED_TASKS, null, 2)};
`;

fs.writeFileSync(targetFile, fileHeader, 'utf8');
console.log('✅ Generated shopifyDeveloperAdvanced.data.ts successfully!');
console.log(`- Tasks count: ${ALL_ADVANCED_TASKS.length}`);
console.log(`- MCQs count: ${ADVANCED_ASSESSMENT.length}`);
